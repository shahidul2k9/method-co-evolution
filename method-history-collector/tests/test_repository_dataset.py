...
class RepositoryDatasetTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.repositories_df = pd.read_csv(f"{EXPERIMENT_DIRECTORY}/project.csv")
    ...
    def test_repository_deduplication(self):
        self.assertEqual(len(set(self.repositories_df["project"].tolist())), len(self.repositories_df), "Duplicate name")
