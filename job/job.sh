...
Usage:
  ...
  job.sh --command llm-m2m-link --api-type huggingface --model-name-or-path openai/gpt-oss-20b --short-model-name gpt_oss_20b --prompt-format text --projects "commons-io" --input-kind t2p
