...
def build_row(tool: str, strategy: str, project: str, df: pd.DataFrame, change_columns: list[str]) -> dict:
    row = {
        "project": project,
        "tool": tool,
        "strategy": strategy,
...
def main(argv: list[str] | None = None) -> None:
    ...
    for tool in tools:
        ...
        for strategy in strategies:
            ...
            for csv_file in csv_files:
                ...
                rows.append(build_row(tool, strategy, csv_file.stem, df, selected_change_columns))

    output_columns = ["project", "tool", "strategy", "methods", *selected_change_columns]
    ...
    if not output_df.empty:
        ...
        for column in ["methods", *selected_change_columns]:
