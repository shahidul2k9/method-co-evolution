...
def print_ground_truth_filter_summary(rows: list[dict[str, object]]) -> None:
    if not rows:
        return
...
def filter_expanded_candidate_files(selected_projects: list[str] | None) -> None:
...
def filter_candidate_files_by_ground_truth(selected_projects: list[str] | None) -> None:
    rows = []
    skipped = []
    ...
    print_ground_truth_filter_summary(rows)
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.ground_truth:
        filter_candidate_files_by_ground_truth(selected_projects)
    else:
        filter_expanded_candidate_files(selected_projects)
